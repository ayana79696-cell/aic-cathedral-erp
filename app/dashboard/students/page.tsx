...
export default async function Students(){
 ...
 const [{data:students},{data:classes},{data:streams},{data:profile}]=await Promise.all([
  ...
  s.from('profiles').select('role').eq('id',(await s.auth.getUser()).data.user?.id||'').maybeSingle()
 ])
