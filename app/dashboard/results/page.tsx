...
export default async function Page(){return <main className="main"><header className="top"><div><h1>Results & Report Forms</h1><p className="muted">Live learner marks, achievement levels and report-form preparation.</p></div></header><ResultsWorkspace/></main>}
